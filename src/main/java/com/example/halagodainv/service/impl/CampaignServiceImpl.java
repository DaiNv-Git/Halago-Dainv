...
public class CampaignServiceImpl implements CampaignService {
    ...
    public Object add(CampaignAddRequest campaignAddRequest) throws ParseException {
        try {
            ...
            campaignEntity.setImg(fileImageUtil.uploadImage(CAMPAIGN, campaignAddRequest.getCampaignImage()));
            ...
            campaignAddRequest.getImageProductAddRequests().forEach(i -> {
                ...
                imageProductEntity.setImageProduct(fileImageUtil.uploadImage(CAMPAIGN, i.getImageProduct()));
    ...
    public Object edit(CampaignEditRequest campaignEditRequest) throws ParseException {
        try {
            ...
            editEntity.setImg(fileImageUtil.uploadImage(CAMPAIGN, campaignEditRequest.getCampaignImage()));
