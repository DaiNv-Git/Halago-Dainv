...
public interface NewsRepository extends JpaRepository<NewsEntity, Integer> {
    ...
    @Query(value = "select new com.example.halagodainv.dto.hompage.NewsTenDto(n.titleSeo,pl.title, n.thumbnail,pl.description,n.created,n.authorAvatar,n.authorName) " +
