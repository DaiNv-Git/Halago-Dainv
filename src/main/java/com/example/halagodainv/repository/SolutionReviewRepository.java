...
public interface SolutionReviewRepository extends JpaRepository<SolutionReviewEntity, Long> {
    @Query("select new com.example.halagodainv.dto.solution.review.SolutionReviewMapEntity(i.id,i.title,i.content,i.contentDetail,ie.titleEN,ie.contentEN,ie.contentDetailEN) from " +
